...
JQL_DIRETO = 'project = ODR AND issuetype IN (Bug, "BUG - SPRINT", "Débito Técnico", História, Melhoria, Tarefa, "Suíte de Teste") AND status IN (Done, "IN ASSISTED OPERATION", "IN CODING", "PENDING APPROVAL", "Pending Estimate", "READY TO DEPLOY (SDXOK)", "To Do", "EM HOMOLOGAÇÃO (SdBx)", "EM HOMOLOGAÇÃO (STG)", "Evidência DEV (STG)", "PRONTO PARA SANDBOX", "TESTE DEV (STG)") AND project = ODR AND assignee IN (61327d3f98a977006b1499ca, 712020:44938e36-874b-4f7c-ad56-f58caa54b2a4, 60d322e0c90cb200686479f0, 62026e8cc4e2c9006ae5ff19, 712020:7a7bab5f-220a-4380-9987-741f797b6ca0, 62c2df061bb561c33794dfd0, 613fa2fe54762c0069281495, 5faa8fef14da2600684768e0, 5e1c688dbf70110ca24c7c73, 5e3c700e3f647d0c99d80da0, 712020:3ae7e23d-d873-4a79-8f9a-39906fb4abef, 712020:82bdc015-0e9e-4064-b307-6f7a2192ef35, 6245b04af813eb00692a1beb) AND sprint = 2015 ORDER BY status ASC, assignee ASC, updated DESC'
